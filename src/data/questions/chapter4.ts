...
export const chapter4Topics: Topic[] = [
  {
    ...
    questions: [
      {
        id: 'q4-1-1',
        text: 'Tìm $\\frac{3}{4}$ của $20$:',
        options: ['$10$', '$15$', '$25$', '$30$'],
        correctAnswerIndex: 1,
        explanation: 'Giá trị phân số của một số = Số đó $\\times$ Phân số = $20 \\times \\frac{3}{4} = 15$.'
      },
      {
        id: 'q4-1-2',
        text: 'Tìm một số biết $\\frac{2}{5}$ của nó bằng $10$:',
        options: ['$4$', '$20$', '$25$', '$50$'],
        correctAnswerIndex: 2,
        explanation: 'Số cần tìm = Giá trị : Phân số = $10 : \\frac{2}{5} = 10 \\times \\frac{5}{2} = 25$.'
      },
      {
        id: 'q4-1-3',
        text: 'Lớp 6A có $40$ học sinh, trong đó $\\frac{1}{4}$ là học sinh giỏi. Số học sinh giỏi là:',
        options: ['$10$', '$20$', '$30$', '$40$'],
        correctAnswerIndex: 0,
        explanation: 'Số học sinh giỏi = $40 \\times \\frac{1}{4} = 10$.'
      }
    ]
  },
  {
    ...
    questions: [
      {
        ...
        options: ['$5$', '$10$', '$15$', '$20$'],
        correctAnswerIndex: 1,
        explanation: 'Giá trị phần trăm = Số đó $\\times$ Phần trăm = $50 \\times 20\\% = 50 \\times \\frac{20}{100} = 10$.'
      },
      {
        id: 'q4-2-2',
        ...
        correctAnswerIndex: 1,
        explanation: 'Số cần tìm = Giá trị : Phần trăm = $30 : 15\\% = 30 : \\frac{15}{100} = 30 \\times \\frac{100}{15} = 200$.'
      },
      {
        id: 'q4-2-3',
    ...
    questions: [
      {
        ...
        options: ['$s = \\frac{v}{t}$', '$s = \\frac{t}{v}$', '$s = v \\times t$', '$s = v + t$'],
        correctAnswerIndex: 2,
      ...
      },
      {
        ...
        correctAnswerIndex: 1,
        explanation: '$s = v \\times t = 50 \\times 2.5 = 125$ km.'
      },
      {
        id: 'q4-3-3',
        ...
        correctAnswerIndex: 0,
        explanation: '$v = \\frac{s}{t} = \\frac{30}{2} = 15$ km/h.'
      }
    ]
  }
];
